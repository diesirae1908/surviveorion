...
export function patrolDateStr(now: Date = new Date()): string {
...
export function patrolOffsetMs(now: number | Date = Date.now()): number {
...
export function patrolDayStartMs(dateStr: string): number {
...
export function nextPatrolMidnight(now: Date = new Date()): Date {
